...
Sie können für Ihre Internetrecherche z.B. Suchmaschinen nutzen, die explizit auf das Auffinden von OER ausgerichtet sind oder Internetseiten wählen, die offen lizenzierte Materialien bereitstellen. Dies sind z.B. 
  ...
  <div class="panel">
    <p>Haben Sie Material gefunden, das Sie gern auf twillo bereitstellen möchten, prüfen Sie, ob dieses den Merkmalen von OER entspricht. Beginnen Sie mit der Lizenz: Ein eindeutiger <b>Lizenzhinweis</b> sollte direkt am Material oder als begleitende Information gespeichert sein. Damit Sie das gefundene Material auf twillo teilen können, muss der Lizenzhinweis zumindest eine Information zu der <b>Lizenz</b> und der <b>Lizenzversion</b> (z.B. 2.0, 3.0 oder 4.0) enthalten, unter der das Material veröffentlicht wurde. 
      Enthält die Lizenz das Modul <b>BY</b> müssen auch die Autor:innen ersichtlich sein. Handelt es sich um Material, das unter der Lizenzversion 3.0 (oder früheren) veröffentlicht wurde, benötigen Sie auch einen Titel. Dies lässt sich darauf zurückführen, dass mind. diese Angaben erforderlich sind, damit Sie die Metadaten des Materials auf twillo korrekt übernehmen können.
